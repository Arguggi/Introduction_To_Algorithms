...
typedef struct Maxtag /**<Struct containing 2 indexs and the sum of array[maxlf] to array[maxrt]*/
{
  int maxlf; /**< Left index of the maximum subarray */
  int maxrt; /**< Right index of the maximum subarray */
  int maxsum; /**< Sum of the elements from array[maxlf] to [maxrt] */
}Max; /**<Name of the struct:*/
